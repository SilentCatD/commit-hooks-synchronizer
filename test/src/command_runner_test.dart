...
import 'package:remote_hooks/src/command_runner.dart';
...
void main() {
  group('RemoteHooksCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late RemoteHooksCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = RemoteHooksCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = RemoteHooksCommandRunner();
